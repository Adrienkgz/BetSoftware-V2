...
class BTSPredictNeuralNetwork:
    ...
    def create_model(self, number_parameter: int):
        ...
        lstm_layer = tf.keras.layers.Conv1D(filters=256, kernel_size=3, activation='relu', padding='same')
    ...
    def train(self, x_training, y_training):
        ...
        self.model.fit(x=x_training, y=y_training, verbose=1, epochs=100, batch_size=32, validation_split=0.2, use_multiprocessing=False, callbacks=[early_stopping])
    ...
    def test_this_league(self, league_str, desired_output='bts', n:int=10):
        ...
        compteur_bts, compteur_total = 0, 0
        ...
        print(f'Pourcentage de matchs BTS : {compteur_bts/compteur_total*100:.2f}%')
        return score
...
list_league_to_test = ['PL20232024',
                       ...
                       'BL20232024',
                       'L120232024',]
desired_output = '+2.5' # 'bts' or '+2.5' or 'winner'
x, y, _ = data.get_all_datas(list_league_to_exclude=list_league_to_test, desired_output=desired_output, n=n, balanced_data=True)
#nn.load_weight()
